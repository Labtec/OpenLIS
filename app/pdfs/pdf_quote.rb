...
class PDFQuote < Prawn::Document
  ...
  def initialize(quote, signature, view_context)
    ...
    if @quote.patient_retiree?
      text "<sup>#{FOOTNOTE_SYMBOLS[1]}</sup>Los panameños o extranjeros residentes en el territorio nacional que tengan cincuenta y cinco (55) años o más, si son mujeres; o sesenta (60) años o más, si son varones; y todos los jubilados y pensionados por cualquier género, gozarán de un descuento del #{QuoteLineItem::RETIREE_PERCENTAGE_DISCOUNT}%.", inline_format: true
    end
