...
class ClaimsReport < Prawn::Document
  ...
  def initialize(claims, view_context)
    ...
    @claims.each do |claim|
      ...
      # Form Locator (FL) 2 - (Untitled) Pay-to Name, Address, and Telephone Number
      # Situational. Required when the pay-to name and address information is different than the Billing Provider information in FL1. If used, the minimum entry is the provider name, address, city, State, and ZIP code.
      # bounding_box([left_margin + provider_info_width, (top_margin + field_height * 4)], :width => pay_to_info_width, :height => field_height) do
      #   pad(form_padding) do
      #     indent(form_indenting * 3) do
      #       text "<b>Labtec S.A.</b>", :inline_format => true
      #     end
      #   end
      # end
      # bounding_box([left_margin + provider_info_width, (top_margin + field_height * 3)], :width => pay_to_info_width, :height => field_height) do
      #   pad(form_padding) do
      #     indent(form_indenting * 3) do
      #       text "Villa Lucre, Consultorios San Judas Tadeo #107"
      #     end
      #   end
      # end
      # bounding_box([left_margin + provider_info_width, (top_margin + field_height * 2)], :width => pay_to_info_width, :height => field_height) do
      #   pad(form_padding) do
      #     indent(form_indenting * 3) do
      #       text "Tel: 222-9200 ext. 1107 • Fax: 277-7832"
      #     end
      #   end
      # end
      # bounding_box([left_margin + provider_info_width, (top_margin + field_height)], :width => pay_to_info_width, :height => field_height) do
      #   pad(form_padding) do
      #     indent(form_indenting * 3) do
      #       text "masterlab@labtecsa.com"
      #     end
            ...
            :cell_style => { :size => 8, :height => field_height, :padding => [form_padding - 2.5, form_padding - 2.5], :inline_format => true } do |t|
              t.before_rendering_page do |page|
                unless @background_form
                  stamp('ub04')
                  # TODO: Fill in form. Create a general method that encompasses
                  # all the other fields (without main table) and call it here.
                  #
                  # The bounds are the main table
                  # Form Locator (FL) 1 - (Untitled) Provider Name, Address, and Telephone Number
                  # Required. The minimum entry is the provider name, city, State, and ZIP code. The post office box number or street name and number may be included. The State may be abbreviated using standard post office abbreviations. Five or nine-digit ZIP codes are acceptable. This information is used in connection with the Medicare provider number (FL 51) to verify provider identity. Phone and/or Fax numbers are desirable.
