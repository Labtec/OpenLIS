...
class AgeDurationTest < ActiveSupport::TestCase
  ...
  test 'medical adult age' do
    birth_date = 18.years.ago.in_time_zone.to_date
    today = Date.today

    age = ActiveSupport::Duration.age(birth_date, today)
    assert_equal 18, age.in_years.round, 'medical adult age'
  end
  ...
  test 'age duration between different months' do
    ...
    age = ActiveSupport::Duration.age(birth_date, today)
    assert_equal 0, age.in_years.round, '0 years'
    assert_equal 0, age.in_months.round, '0 months'
    assert_equal 2, age.in_days.round, '2 day'
    ...
    assert_equal 0, age.in_years.round, '0 years'
    assert_equal 0, age.in_months.round, '0 months'
    assert_equal 2, age.in_days.round, '2 days'
    ...
    assert_equal 0, age.in_years.round, '0 years'
    assert_equal 0, age.in_months.round, '0 months'
    assert_equal 3, age.in_days.round, '3 days'
    ...
    assert_equal 0, age.in_years.round, '0 years'
    assert_equal 0, age.in_months.round, '0 months'
    assert_equal 4, age.in_days.round, '4 days'
  end
